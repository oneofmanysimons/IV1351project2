...
CREATE TABLE rent_instrument (
 ...
 student_id INT NOT NULL,
 date_rent TIMESTAMP(10),
 date_return TIMESTAMP(10),
 date_must_return TIMESTAMP(10),
 price INT
);
...
ALTER TABLE student_pay ADD CONSTRAINT FK_student_pay_3 FOREIGN KEY (sibling_attend) REFERENCES sibling_attend (sibling_id);
