...
ALTER TABLE lesson_record ADD CONSTRAINT PK_lesson_record PRIMARY KEY (lesson_id);
...
ALTER TABLE instructor_pay ADD CONSTRAINT PK_instructor_pay PRIMARY KEY (instructor_id,lesson_id);
...
ALTER TABLE student_pay ADD CONSTRAINT PK_student_pay PRIMARY KEY (student_id,lesson_id);
...
ALTER TABLE lesson_record ADD CONSTRAINT FK_lesson_record_0 FOREIGN KEY (lesson_id) REFERENCES individual_lesson (lesson_id);
ALTER TABLE lesson_record ADD CONSTRAINT FK_lesson_record_1 FOREIGN KEY (lesson_id) REFERENCES group_lesson (lesson_id);
ALTER TABLE lesson_record ADD CONSTRAINT FK_lesson_record_2 FOREIGN KEY (lesson_id) REFERENCES ensemble (lesson_id);
ALTER TABLE lesson_record ADD CONSTRAINT FK_lesson_record_3 FOREIGN KEY (lesson_id) REFERENCES lesson (lesson_id);
...
ALTER TABLE students ADD CONSTRAINT FK_students_2 FOREIGN KEY (lesson_id_1) REFERENCES lesson_record (lesson_id);


ALTER TABLE instructor_pay ADD CONSTRAINT FK_instructor_pay_0 FOREIGN KEY (lesson_id) REFERENCES lesson_record (lesson_id);
...
ALTER TABLE student_pay ADD CONSTRAINT FK_student_pay_0 FOREIGN KEY (lesson_id) REFERENCES lesson_record (lesson_id);
ALTER TABLE student_pay ADD CONSTRAINT FK_student_pay_1 FOREIGN KEY (sibling_attend) REFERENCES sibling_attend (sibling_id);
